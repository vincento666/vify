...
describe('ChatView Ant Design Vue migration', () => {
  it('keeps ChatView off Element Plus tags, imports, and style internals', () => {
    const content = readProjectFile('src/views/chat/ChatView.vue')
    const matches = [
