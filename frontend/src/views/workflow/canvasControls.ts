...
export const CANVAS_ENDPOINT_BASE_DIAMETER_REM = 0.875
export const CANVAS_NODE_HOVER_ENDPOINT_SCALE = 2
export const CANVAS_ENDPOINT_HOVER_SCALE = 3
export const CANVAS_ENDPOINT_CONNECTED_SCALE = CANVAS_ENDPOINT_HOVER_SCALE
export const CANVAS_ENDPOINT_HIT_DIAMETER_REM = CANVAS_ENDPOINT_BASE_DIAMETER_REM * CANVAS_ENDPOINT_HOVER_SCALE
