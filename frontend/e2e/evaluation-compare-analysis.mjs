...
try {
  ...
  await page.getByRole('tab', { name: 'Compare Analysis' }).click()
  ...
  await page.getByText('Score Delta').waitFor({ state: 'visible', timeout: 10000 })
  await assertBodyIncludes(page, '+25.0%')
  await assertBodyIncludes(page, 'Newly Failed 1')
  await assertBodyIncludes(page, 'Recovered 2')
  await assertBodyIncludes(page, 'Unchanged Failures 1')
