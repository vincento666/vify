...
- [x] Add RED backend integration test for missing demo-story discovery API.
- [x] Add RED frontend unit test for missing story load runtime helper.
- [x] Save RED output to
  `artifacts/slices/074-customer-service-workbench-loop-productization/074.1/red.txt`.
- [x] Implement backend demo-story listing endpoint.
- [x] Implement frontend API/runtime story loading helpers.
- [x] Add story selector to customer-assistant workbench.
